package com.example.tugasuts.data;
...
public class DataMakanan {
    ...
    public static String[][] data = new String[][]{
            {
                    ...
                    "http://static.food2fork.com/chickenandcashewnuts_89299_16x9986b.jpg",
            ...
            },
            {
                    ...
                    "http://static.food2fork.com/466_1_1349094314_lrg2129.jpg",
            ...
            },
            {
                    ...
                    "http://static.food2fork.com/2028272b37.jpg",
            ...
            },
            {
                    ...
                    "http://static.food2fork.com/1364637_MEDIUMc356.jpg",
            ...
            },
            {
                    ...
                    "http://static.food2fork.com/333612_MEDIUM064c.jpg",
            ...
            },
            {
                    ...
                    "http://static.food2fork.com/197075_medium0a7a.jpg",
            ...
            },
            {
                    ...
                    "http://static.food2fork.com/2398_MEDIUMb464.jpg",
            ...
            },
            {
                    ...
                    "350g pasta\n" +
                            ...
                            "200g broccoli\n" +
                            "\n" +
                            ", cut into very small florets and the stems thinly sliced\n" +
                            "2 tbsp olive oil\n" +
                            "\n" +
                            "350g boneless, skinless chicken\n" +
                            "\n" +
            ...
            },
            {
                    ...
                    "http://static.food2fork.com/1162660_MEDIUMe96a.jpg",
            ...
            },
            {
                    ...
                    "http://static.food2fork.com/bakedchicken_3003ddb97a2.jpg",
            ...
            },
            {
                    ...
                    "http://static.food2fork.com/988637_MEDIUMabfc.jpg",
            ...
            },
            {
                    "BBC Good Food",
                    "Christmas pie",
                    "http://static.food2fork.com/2793_MEDIUMaa84.jpg",
            ...
            },
            {
                    ...
                    "1. Bring broth to a boil in a large Dutch oven and add chicken. Simmer until chicken is cooked through, about 25 minutes. Remove chicken, saving broth in same pot, and cool. Shred into bite sized pieces.\n\n" +
                            ...
                            "3. Melt butter in small saucepan. Whisk in flour and cook, whisking constantly, for about 3 minutes. Add to simmering broth and cook for 5-10 minutes until slightly thickened.\n\n" +
            ...
            },
            {
                    ...
                    "http://static.food2fork.com/4787_MEDIUM14f8.jpg",
            ...
            },
            {
                    ...
                    "1. Place the buttermilk in a large, shallow dish; set aside. Combine the flour, sugar, measured salt, paprika, measured pepper, baking powder, and ground mustard in another large, shallow dish and whisk to combine; set aside.\n\n" +
                            ...
                            "3. To bread the chicken, dip 1 piece in the buttermilk and let the excess drip off. Dredge in the flour mixture and shake off any excess. Set the coated chicken on a baking sheet and repeat with the remaining pieces.\n\n" +
                            "4. Heat the oil in a large frying pan over medium-high heat until shimmering but not smoking (about 350°F on a deep-frying/candy thermometer). Meanwhile, fit a wire rack over a second baking sheet; set aside.\n\n" +
                            "5. When the oil is ready, add 2 pieces of the chicken and fry until golden brown and cooked through, about 2 minutes per side. Remove to the wire rack and season with salt. Repeat with the remaining chicken. Cover the fried chicken loosely with a piece of aluminum foil; set aside.\n\n" +
                            "6. To serve, stem and thinly slice the pickled peppers. Evenly divide the mayonnaise among the rolls, spreading it all over both of the cut sides. Place the chicken pieces on the rolls, top with the lettuce and peppers, and serve immediately."
            }
    ...
    public static ArrayList<Makanan> getListData(){
        ...
        makanan = new Makanan();
        makanan.setPublisher(aData[0]);
        makanan.setTitle(aData[1]);
        makanan.setFoto(aData[2]);
        makanan.setDesc(aData[3]);
        makanan.setRecipe(aData[4]);
        makanan.setMethod(aData[5]);
